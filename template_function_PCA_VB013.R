...
PCA_VB013 <- function(VB013_LCF, Meta_VB013_Outlier_rem){
    # image: png
    ...
    samples_to_include = c("H02V_BASAL","H02V_wk13","H21Y_wk13","H22D_wk13","H22E_BASAL","H22E_wk13","H22F_wk13","H22H_BASAL","H24C_BASAL","H24D_wk13","H24H_wk13","H28T_wk13","H28V_wk13","H28Y_wk13","H29N_BASAL","H30G_BASAL","H34F_BASAL","H35H_wk13","H35R_wk13")
    samples_to_include <- samples_to_include[samples_to_include != "Gene"]

    VB013_LCF %>% dplyr::select(append("Gene", samples_to_include)) -> spark.df
    
    spark.df %>% dplyr::collect() -> edf.orig

    Sampinfo <- dplyr::collect(Meta_VB013_Outlier_rem)
...
print("template_function_PCA_VB013.R #########################################################################")
...
var_PCA_VB013<-PCA_VB013(var_VB013_LCF,var_Meta_VB013_Outlier_rem)
invisible(graphics.off())
saveRDS(var_PCA_VB013, paste0(rds_output,"/var_PCA_VB013.rds"))
